                            ...
                            <div className="introy">
                                <div className="txt_area">
                                    <p>
                                        ...
                                        미화산업국제표준(CIMS) 인증을
                                        세계청결산업협회(ISSA)로부터
                                        획득하였으며, 2020년에는 20년간 축적된
                                        빌딩관리 고객서비스의 노하우를 바탕으로
                                        하루가 다르게 변하는 트렌드와 시대의
                                        변화에 대처하기 위해 홈클리닝 사업에
                                        진출함으로써 개인 고객에게도 고품질의
                                        서비스를 제공하게 되었습니다.
                                        <br />
                                        <br />
                                        깨끗한 세상을 위한 걸음에 앞장서며
                                        고객감동을 위한 변화와 혁신을 실행하는
                                        기업 제일종합관리서비스는 언제나 여러분
                                        곁에 함께하겠습니다.
                                    </p>
                                </div>
                            </div>
