            ...
            <div className="warp">
                ...
                <div className="choose2">
                    ...
                    <p className="textarea-p">
                        자세한 사항은 고객센터(1877-0000)에 문의하시기 바랍니다.
                    </p>
                </div>
                ...
                <div className="data_box">
                    <div className="data">
                        ...
                        <p className="sub_tit">1. 개인정보의 처리 목적</p>

                        <p className="txt">
                            {' '}
                            ('www.project.co.kr''이하
                            '프로젝트관리서비스(주)')은(는) 개인정보를 다음의
                            목적을 위해 처리합니다. 처리한 개인정보는 다음의
                            목적이외의 용도로는 사용되지 않으며 이용 목적이
                            변경될 시에는 사전동의를 구할 예정입니다.
                            <br />
                            가. 홈페이지 회원가입 및 관리 <br />
                            회원 가입의사 확인, 회원제 서비스 제공에 따른 본인
                            식별·인증, 회원자격 유지·관리, 제한적 본인확인제
                            시행에 따른 본인확인, 서비스 부정이용 방지, 만14세
                            미만 아동 개인정보 수집 시 법정대리인 동의 여부
                            확인, 각종 고지·통지, 고충처리, 분쟁 조정을 위한
                        ...
                        <p className="sub_tit">2. 개인정보 파일 현황</p>
                        ...
                        <p className="txt">
                            ① ('프로젝트관리서비스(주)')은(는) 법령에 따른
                            개인정보 보유·이용기간 또는 정보주체로부터
                            개인정보를 수집시에 동의 받은 개인정보 보유,이용기간
                        ...
                        <p className="sub_tit">
                            ...
                            이용자는 개인정보주체로써 다음과 같은 권리를 행사할
                            수 있습니다.
                        </p>
                        <p className="txt">
                            ① 정보주체는 프로젝트관리서비스(주)에 대해 언제든지
                            개인정보 열람,정정,삭제,처리정지 요구 등의 권리를
                            행사할 수 있습니다. <br />
                            ② 제1항에 따른 권리 행사는프로젝트관리서비스(주)에
                            대해 개인정보 보호법 시행령 제41조제1항에 따라 서면,
                            전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며
                            프로젝트관리서비스(주)은(는) 이에 대해 지체 없이
                            조치하겠습니다. <br />
                            ③ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나
                            위임을 받은 자 등 대리인을 통하여 하실 수 있습니다.
                            이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에
                            따른 위임장을 제출하셔야 합니다. <br />
                            ④ 개인정보 열람 및 처리정지 요구는 개인정보보호법
                            제35조 제5항, 제37조 제2항에 의하여 정보주체의
                            권리가 제한 될 수 있습니다. <br />
                            ⑤ 개인정보의 정정 및 삭제 요구는 다른 법령에서 그
                            개인정보가 수집 대상으로 명시되어 있는 경우에는 그
                            삭제를 요구할 수 없습니다. <br />⑥
                            프로젝트관리서비스(주)은(는) 정보주체 권리에 따른
                        ...
                        <p className="sub_tit">
                            7. 개인정보 자동 수집 장치의 설치•운영 및 거부에
                            관한 사항
                        </p>
                        <p className="txt">
                            프로젝트관리서비스(주) 은 정보주체의 이용정보를
                            저장하고 수시로 불러오는 ‘쿠키’를 사용하지 않습니다.
                        </p>

                        <p className="sub_tit">8. 개인정보 보호책임자 작성</p>

                        <p className="txt">
                            ① 프로젝트관리서비스(주)(‘www.project.co.kr'’이하
                            ‘프로젝트관리서비스(주)) 은(는) 개인정보 처리에 관한
                            ...
                            <br />② 정보주체께서는
                            프로젝트관리서비스(주)(‘www.project.co.kr'’이하
                            ‘프로젝트관리서비스(주)) 의 서비스(또는 사업)을
                            이용하시면서 발생한 모든 개인정보 보호 관련 문의,
                            불만처리, 피해구제 등에 관한 사항을 개인정보
                            보호책임자 및 담당부서로 문의하실 수 있습니다.
                            프로젝트관리서비스(주)(‘www.project.co.kr'’이하
                            ‘프로젝트관리서비스(주)) 은(는) 정보주체의 문의에
                            대해 지체 없이 답변 및 처리해드릴 것입니다.
                        </p>

                        <p className="sub_tit">9. 개인정보 처리방침 변경</p>

                        <p className="txt">
                            ①이 개인정보처리방침은 시행일로부터 적용되며, 법령
                            및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는
